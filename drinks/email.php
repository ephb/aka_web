...
<b>Wichtig!</b></u>: Wenn ihr f&uuml;r jemand anderen Geld &uuml;berweist muss der Betreff mit den Buchstaben "xxx" beginnen, gefolgt vom Namen<br>
        ...
        $mail->Subject = "AKA Getränkelisten Update";
        ...
        if (!$mail->Send()) {
            echo '<font color="red"><b>Die Mail an ' . $daten[$a][1] . ' konnte nicht verschickt werden.</b></font><br>';
        } else {
            echo '<font color="green"><b>Die Mail an ' . $daten[$a][1] . ' (' . $daten[$a][12] . ') wurde verschickt.</b></font><br>';
        };
    };
};
...
if (isset ($temp_user) && time() - $daten[$temp_user][7] < 60) { # eigentlich doof aber total praktisch für den email button
    ...
    if (!$mail->Send()) {
        echo '<font color="red"><b>Die Mail an den Admin konnte nicht verschickt werden.</b></font><br>';
    } else {
        echo '<font color="green"><b>Die Mail an den Admin wurde verschickt.</b></font><br>';
    };
